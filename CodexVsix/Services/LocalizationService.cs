...
public sealed class LocalizationService
{
    ...
    private static readonly IReadOnlyDictionary<string, string> PortugueseStrings = new Dictionary<string, string>
    {
        ...
        ["SetupCheckingSummary"] = "Validando executável, autenticação e configuração local.",
        ["SetupMissingExecutableTitle"] = "Codex CLI não encontrado",
        ["SetupMissingExecutableSummary"] = "Instale o Codex CLI e confirme o caminho do executável antes de usar a extensão.",
        ["SetupMissingAuthTitle"] = "Codex encontrado, mas sem login",
        ["SetupMissingAuthSummary"] = "Faça login no Codex CLI ou forneça um OPENAI_API_KEY antes de iniciar uma sessão.",
        ["SetupReadyTitle"] = "Codex pronto para uso",
        ["SetupReadySummary"] = "A extensão já consegue iniciar sessões usando o Codex CLI local.",
        ...
        ["SetupMissingAuthDetail"] = "Execute `codex login` em um terminal ou configure uma API key.",
    ...
    private static readonly IReadOnlyDictionary<string, string> SpanishStrings = new Dictionary<string, string>
    {
        ...
        ["SetupCheckingSummary"] = "Validando el ejecutable, la autenticación y la configuración local.",
        ["SetupMissingExecutableTitle"] = "No se encontró Codex CLI",
        ["SetupMissingExecutableSummary"] = "Instala Codex CLI y confirma la ruta del ejecutable antes de usar la extensión.",
        ["SetupMissingAuthTitle"] = "Codex encontrado, pero falta iniciar sesión",
        ["SetupMissingAuthSummary"] = "Autentícate con Codex CLI o proporciona un OPENAI_API_KEY antes de iniciar una sesión.",
        ["SetupReadyTitle"] = "Codex está listo",
        ["SetupReadySummary"] = "La extensión puede iniciar sesiones con el Codex CLI local.",
        ...
        ["SetupAuthFileLabel"] = "Usando ~/.codex/auth.json",
        ["SetupApiKeyLabel"] = "Usando OPENAI_API_KEY",
        ["SetupMissingAuthDetail"] = "Ejecuta `codex login` en una terminal o configura una API key.",
    ...
    private static readonly IReadOnlyDictionary<string, string> FrenchStrings = new Dictionary<string, string>
    {
        ...
        ["SetupCheckingSummary"] = "Validation de l'exécutable, de l'authentification et de la configuration locale.",
        ["SetupMissingExecutableTitle"] = "Codex CLI introuvable",
        ["SetupMissingExecutableSummary"] = "Installez Codex CLI et confirmez le chemin de l'exécutable avant d'utiliser l'extension.",
        ["SetupMissingAuthTitle"] = "Codex trouvé, mais connexion manquante",
        ["SetupMissingAuthSummary"] = "Authentifiez-vous avec Codex CLI ou fournissez un OPENAI_API_KEY avant de démarrer une session.",
        ["SetupReadyTitle"] = "Codex est prêt",
        ["SetupReadySummary"] = "L'extension peut démarrer des sessions avec le Codex CLI local.",
        ...
        ["SetupMissingAuthDetail"] = "Exécutez `codex login` dans un terminal ou configurez une clé API.",
    ...
    private static readonly IReadOnlyDictionary<string, string> GermanStrings = new Dictionary<string, string>
    {
        ...
        ["SetupCheckingSummary"] = "Ausführbare Datei, Authentifizierung und lokale Konfiguration werden validiert.",
        ["SetupMissingExecutableTitle"] = "Codex CLI nicht gefunden",
        ["SetupMissingExecutableSummary"] = "Installieren Sie Codex CLI und bestätigen Sie den Pfad der ausführbaren Datei, bevor Sie die Erweiterung verwenden.",
        ["SetupMissingAuthTitle"] = "Codex gefunden, aber Anmeldung fehlt",
        ["SetupMissingAuthSummary"] = "Melden Sie sich mit Codex CLI an oder geben Sie einen OPENAI_API_KEY an, bevor Sie eine Sitzung starten.",
        ["SetupReadyTitle"] = "Codex ist bereit",
        ["SetupReadySummary"] = "Die Erweiterung kann Sitzungen mit der lokalen Codex CLI starten.",
        ...
        ["SetupMissingAuthDetail"] = "Führen Sie `codex login` in einem Terminal aus oder konfigurieren Sie einen API-Schlüssel.",
