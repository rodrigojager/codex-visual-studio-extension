...
public sealed class LocalizationService
{
    private static readonly IReadOnlyDictionary<string, string> EnglishStrings = new Dictionary<string, string>
    {
        ...
        ["SetupMissingAuthTitle"] = "Codex is available, but login is missing",
        ["SetupMissingAuthSummary"] = "Authenticate with Codex or provide an OPENAI_API_KEY before starting a session.",
        ...
        ["SetupMissingAuthDetail"] = "Run `codex login` or configure an API key.",
    ...
    private static readonly IReadOnlyDictionary<string, string> PortugueseStrings = new Dictionary<string, string>
    {
        ...
        ["SetupMissingAuthTitle"] = "Codex disponível, mas sem login",
        ...
        ["SetupMissingAuthDetail"] = "Execute `codex login` ou configure uma API key.",
    ...
    private static readonly IReadOnlyDictionary<string, string> SpanishStrings = new Dictionary<string, string>
    {
        ...
        ["SetupMissingAuthTitle"] = "Codex está disponible, pero falta iniciar sesión",
        ...
        ["SetupAuthFileLabel"] = "Usando ~/.codex/auth.json",
        ["SetupApiKeyLabel"] = "Usando OPENAI_API_KEY",
        ["SetupMissingAuthDetail"] = "Ejecuta `codex login` o configura una API key.",
    ...
    private static readonly IReadOnlyDictionary<string, string> FrenchStrings = new Dictionary<string, string>
    {
        ...
        ["SetupMissingAuthTitle"] = "Codex est disponible, mais la connexion manque",
        ...
        ["SetupMissingAuthDetail"] = "Exécutez `codex login` ou configurez une clé API.",
    ...
    private static readonly IReadOnlyDictionary<string, string> GermanStrings = new Dictionary<string, string>
    {
        ...
        ["SetupMissingAuthTitle"] = "Codex ist verfügbar, aber die Anmeldung fehlt",
        ...
        ["SetupMissingAuthDetail"] = "Führen Sie `codex login` aus oder konfigurieren Sie einen API-Schlüssel.",
    ...
    public string SetupMissingAuthTitle => GetLocalizedString("SetupMissingAuthTitle", "Codex disponível, mas sem login");
    ...
    public string SetupMissingAuthDetail => GetLocalizedString("SetupMissingAuthDetail", "Execute `codex login` ou configure uma API key.");
